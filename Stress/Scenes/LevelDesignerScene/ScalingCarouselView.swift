...
open class ScalingCarouselView: UICollectionView {
    ...
    override open func scrollToItem(at indexPath: IndexPath,
    ...
    */
    ...
    public func deviceRotated() {
        guard let lastCurrentCenterCellIndex = currentCenterCellIndex ?? lastCurrentCenterCellIndex else {
            return
        }
...
fileprivate extension PrivateAPI {
    ...
    func configureLayout() {
        ...
        */
        invisibleWidthConstraint = invisibleScrollView.widthAnchor.constraint(equalTo: widthAnchor,
                                                                              constant: -(2 * inset))
...
extension InvisibleScrollDelegate: UIScrollViewDelegate {
    ...
    public func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        guard let indexPath = currentCenterCellIndex else {
            return
        }
        lastCurrentCenterCellIndex = indexPath
    }
